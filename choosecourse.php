...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-left:100px;margin-top:50px;">
		      <ul class="nav navbar-nav">
			<li CLASS="active"><a href="">CHOOSE YOUR COURSE</a></li>
				<li CLASS="active"><a href=""><img src="images/nnm.jpg"></a></li>
            </ul>
			</div></nav>
<div class="main_btm">	<div class="container">
		<div class="main row">
				<div class="col-md-12">
				  <div class="contact-form">
				  	<center><h3>PLEASE CHOOSE YOUR COURSE</h3>
					    <form>
					    	
						   		<label><a class="fa-btn btn-1 btn-1e" href="registration.php">NOW CLICK HERE FOR FUTHER REGISTRATION PROCESS</a></label>
						  </div>
