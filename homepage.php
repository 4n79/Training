...
$sql="SELECT * FROM `studentdata` WHERE mem_id = '$mem_id'";
...
<div class="container">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
		        <li class="active"><a href="sassignment.php">DOWNLOAD STUDY MATERIAL</a></li>
	...
	<div class="container">
		<div class="main row">
				...
				<form action="" method="post" >
				  ...
				  <TD rowspan=5>
				  <img src="images/p-4.jpg" alt="" class="blog_img img-responsive"  height='230' width='230'/>
				  </TD>
				 ...
				 <tr></tr>
				  ...
				  <tr style="background-color:#920808;font-weight:bold;font-size:15px;color:#fff;">
				  <TD colspan=2>Address<?php echo $a['address']; ?></td></TD>
				  </TR>
				  <tr style="background-color:#920808;font-weight:bold;font-size:15px;color:#fff;">
				  <TD colspan=2>mobilen no:<?php echo $a['mobile_no']; ?></td>
				  </tr>
...
<div class="col-md-8 company_ad">
			 ...
			 <h3>WELCOME TO OUR STUDENT </h3>
			 <H3> <img src="images/t-pic10.jpg" alt="" class="blog_img img-responsive"/></H3>
			 <div style="height:340px;width:100%;border:solid;float:right;background-color:#920808;">		 <marquee behavior="scroll" direction="up" onMouseOver="this.stop();" onMouseOut="this.start();"><ul style="font-weight:bold;font-size:15px;color:#fff;">
