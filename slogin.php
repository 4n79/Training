...
error_reporting(0);   
	...
	if($submit){
		...
		$r="select * from studentdata where username='$uname' and email='$email' and password='$password' ";
		...
		<nav class="navbar navbar-default navbar-left" role="navigation">
		  ...
		  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
				<li class="active"><a href=" ">WELCOME TO OUR STUDENT LOGIN FORM</a></li>
				 <li><a href="home.php">HOME</a></li>
				<li><a href=" registration.php">FOR NEW REGISTRATION CLICK ME</a></li>
...
<div class="main_btm">
	<div class="container">
		<div class="main row">
			    <div class="col-md-4 company_ad">
				 <div class="contact-form">
				  	<h2>LOGIN FORM</h2>
					    ...
					    <div>
						    	<span>USERNAME</span>
						    	<span><input type="username" class="form-control" name="uname"></span>
						    </div>
						    <div>
						    	<span>e-mail</span>
				...
				<div class="col-md-8">
               <h2>WELCOME TO OUR STUDENT LOGIN FORM:</h2>
				   <H3> <img src="images/b.jpg" alt="" class="blog_img img-responsive"/></H3>
